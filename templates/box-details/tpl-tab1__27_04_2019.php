...
<div class="wrap">
   ...
   <script src="http://ahhthatsthespotmassage.com/wp-content/themes/spotmassage/js/markerclusterer.js"></script>
...
<div id="dialog-send-sms" class="wrap modal-dialog" title="<?php _e('Customize SMS message'); ?>" style="display:none">
    ...
    <div id="popup-editor-notifications">
        ...
        <div id="editortab-1">
            <div><?php echo wp_editor( stripcslashes(get_option('content_email_invitation', '')),'email-invitation-content', array('media_buttons' => false, 'textarea_rows' => 12) ); ?></div>
			<p>
