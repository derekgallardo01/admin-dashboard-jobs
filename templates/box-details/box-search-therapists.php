 ...
 **/$mylead = $wpdb->get_results( "SELECT * FROM ".$wpdb->prefix."rg_lead_meta where meta_key = 'invoice_paid_detail' and lead_id = '".$_GET["lid"]."' " );
 $invoicepaid = (array)unserialize($mylead[0]->meta_value);//print_r($invoicepaid);die();?>
