...
<div id="dialog-send-sms" class="wrap modal-dialog" title="<?php _e('Customize SMS message'); ?>" style="display:none">
    ...
    <img id="ajax_loading-dialog" class="ajax-loading-dialog" 

        src="<?php echo plugins_url('/modal-settings/images/ajax-loader-black.gif', dirname(__FILE__)); ?>" 
    ...
    <div id="popup-editor-notifications">
        ...
        <div id="editortab-1">
            ...
            <div><?php echo wp_editor( stripcslashes(get_option('content_email_invitation', '')),

                                        'email-invitation-content', 

                                        array('media_buttons' => false, 'textarea_rows' => 28) ); ?></div>
        ...
        <div id="editortab-2">
            ...
            <textarea id="sms-message"
                ...
                rows="4" cols="70"><?php echo stripcslashes(get_option('content_sms_invitation', '')) ?></textarea>
