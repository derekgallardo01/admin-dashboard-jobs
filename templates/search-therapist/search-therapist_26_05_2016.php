...
$fields = array('state'=>'15.4','city'=>'15.3','keyword'=>'15.5','name'=>4);
			...
			if(isset($_GET["name"]) && $_GET["name"]!=''){
				...
				$search_criteria['field_filters'][3]['value'] = $_GET["name"];
    ...
    <div class="form-ajax psearch">
       <form method="get" name="search" action="admin.php?page=seach_therapist">
        ...
        <div>
            ...
            <input id="search_name" type="text" name="name" value="<?php echo $_GET["name"];?>" placeholder="<?php echo __('First or Last Name', $lang); ?>" class="inpt-searchs" />
        ...
        <div id="dialog-send-message" class="wrap modal-dialog" title="<?php _e('Send Message', $lang); ?>">
            ...
            <div>
                ...
                Please enter multiple emails (,) Separated
            </div>
